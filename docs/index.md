...
| ![fmriprep usage](https://github.com/nipreps/fmriprep_stats/releases/latest/download/weekly.png?v=today) |
|:--:|
...
| ![fmriprep versions](https://github.com/nipreps/fmriprep_stats/releases/latest/download/versionstream.png?v=today) |
|:--:|
